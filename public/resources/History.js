...
export const techStack = [
  {
    category: { name: "FRONT END", href: "#" },
    description:
      "Some of my most commonly used front end tools include HTML5, CSS | SASS, Tailwind, BootStrap, JavaScript, Next, and React | Redux",
    imageUrl:
  ...
  },
  {
    ...
    description:
      "For server tools, I have extensive experience with Node, Express, and Python.",
    imageUrl:
  ...
  },
  {
    ...
    description:
      "With database related tools, I have experience with SQL, PostgreSQL, mySQL, MongoDB, and Firebase. PostgreSQL is my favorite",
    imageUrl:
  ...
  },
  {
    ...
    description:
      "For deployment, My main toolsets consists of AWS, Git, Docker, Heroku, and Vercel",
    imageUrl:
